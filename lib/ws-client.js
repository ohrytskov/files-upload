...
class WebSocketUploaderClient {
   ...
   * @param {string} options.serverUrl - WebSocket endpoint URL (e.g. "ws://localhost:3001/ws/upload")
  ...
  connectWebSocket() {
    ...
    socket.on('close', (code, reason) => {
      ...
      if ([1002, 1003, 1007, 1008, 1009, SESSION_TAKEN_OVER_CLOSE_CODE].includes(code)) {
        this.stopping = true;
